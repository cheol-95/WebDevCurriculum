...
export default class Login {
  private idBox: CustomElement = document.querySelector('#id');

  private pwBox: CustomElement = document.querySelector('#pw');

  private submit: CustomElement = document.querySelector('.submit');
