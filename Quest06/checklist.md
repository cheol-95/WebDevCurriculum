...
- 유선의 경우 케이블, USB를 통한 시리얼 통신을 사용한다.
- 무선의 경우 블루투스를 사용해 통신한다.
  - 블루투스는 근거리의 두 정보기기 사이에 전파를 이용해서 간단한 정보를 교환한다.
  - 페어링을 통해 연결하며 마스터-슬레이브 구조를 가진다.
...
- Wi-Fi
  - 무선 액세스 포인트(Wireless Access Point -> AP)로 네트워크에 접속한다.
  - 초기 암호화 WEP는 쉽게 뚫릴 수 있었으며, 이후 더 높은 품질의 프로토콜 WPA, WPA2들이 추가되었다.
